...
def plot_one_box(x, img, color=None, label=None, line_thickness=3):
    ...
    if label:
        ...
        textS = cv2.getTextSize(label, 0, tl/3, tf)[0]
        cv2.drawContours(img, [np.array([(c1[0] + textS[0], c1[1] - textS[1] - 3), (c1[0] + textS[0], c1[1] ), (c1[0] + textS[0] + textS[1] + 3, c1[1])])], 0, color, -1, 16)
        print(f'x: {c1[0]}, y: {c1[1]-2}')
